...
export const enum IpcEvents {
    ...
    GET_PLATFORM_INFO = "VCD_GET_PLATFORM_INFO",
    POWER_SAVE_BLOCKER_SET = "VCD_POWER_SAVE_BLOCKER_SET",
    POWER_GET_SYSTEM_IDLE_TIME_MS = "VCD_POWER_GET_SYSTEM_IDLE_TIME_MS",
    POWER_MONITOR_EVENT = "VCD_POWER_MONITOR_EVENT",
    PROXY_TEST = "VCD_PROXY_TEST",
    VENCORD_CHECK_UPDATE = "VCD_VENCORD_CHECK_UPDATE",

    TRAY_GET_ICON_DATA_URL = "VCD_TRAY_GET_ICON_DATA_URL",
    TRAY_SET_BADGE_IMAGE = "VCD_TRAY_SET_BADGE_IMAGE"
}
